...
extern "C" void interrupt(short id);
extern "C" unsigned int isinterrupted(short id=0);
extern "C" void sleep(int millisecondi);
extern "C" short getid();
extern "C" void sem_wait_2(int sem);
